                ...
                <div className="flex flex-col gap-2">
                    { projects && projects.map((project) => (
                        <div
                            className={
                                project.id == id
                                    ? "flex flex-row items-center text-[0.9rem] font-medium text-clip rounded-[6px] text-[rgb(114,115,118)] p-1 bg-gray-200 text-black"
                                    : "flex flex-row items-center text-[0.9rem] font-medium text-clip rounded-[6px] text-[rgb(114,115,118)] p-1 hover:bg-gray-200/30 hover:text-black ease-in-out duration-300"
                            }
                            key={project.id}
                        >
                            <Link
                    ...
                    <Button className="w-full rounded-md text-white bg-[#3A86FF] hover:bg-blue-800 ease-in-out duration-300 justify-start" onClick={() => setIsOpen(true)}>
                        <div className="flex flex-row items-center justify-between w-full">
                            <span className="font-normal text-[1rem]">Добавить проект</span>
                            <Plus size={18} />
                        </div>
                    </Button>
                    <div
                        style={{padding: "8px 16px"}}
                        className="flex flex-row items-center justify-start rounded-md text-[1rem] text-[#727376] w-full dark:text-white text-[rgb(114,115,118)] bg-black/10 text-black">
